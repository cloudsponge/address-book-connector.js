...
describe('contactObject', () => {
  ...
  describe('subject', () => {
    ...
    it('returns the subject', () => {
      ...
      const contact = {}
      expect(contactObject(contact, opts).subject).toEqual('this is an email subject')
    })
  })
  ...
  describe('personal_subject', () => {
    ...
    it('returns the subject', () => {
      const opts = {subject: 'this is an email subject'}
      const contact = {}
      expect(contactObject(contact, opts).personal_subject).toEqual('this is an email subject')
    })
    it('returns the personal_subject', () => {
      const opts = {subject: 'this is an email subject'}
      const contact = {first_name: 'dude'}
      expect(contactObject(contact, opts).personal_subject).toEqual('dude this is an email subject')
    })
  })
  ...
  describe('to', () => {
    ...
    it('returns the formated email with full name', () => {
      const contact = {email: 'email@example.com', first_name: 'yo', last_name: 'last'}
  ...
  describe('the owner object', () => {
    describe('sender_name', () => {
      ...
      it('can be the default', () => {
        ...
        expect(contactObject(contact, {owner: true}).sender_name).toEqual('defaultSenderName')
      })
      it('can be the first and last name', () => {
        const contact = {first_name: 'sender', last_name: 'name', email: 'email@example.com'}
        options.defaultSenderName = 'defaultSenderName'
        expect(contactObject(contact, {owner: true}).sender_name).toEqual('sender name')
      });
    });
    describe('from_name', () => {
      it('can be empty', () => {
      ...
      it('can be the default', () => {
        const contact = {email: 'email@example.com'}
        options.defaultSenderName = 'defaultSenderName'
        expect(contactObject(contact, {owner: true}).from_name).toEqual('defaultSenderName')
      })
      it('can be the first and last name', () => {
        const contact = {first_name: 'sender', last_name: 'name', email: 'email@example.com'}
        options.defaultSenderName = 'defaultSenderName'
        expect(contactObject(contact, {owner: true}).from_name).toEqual('sender name')
      });
    });
    describe('sender_email', () => {
      it('can be absent', () => {
        const contact = {email: 'email@example.com'}
        expect(contactObject(contact, {owner: true}).sender_email).toBe(undefined)
      })
      it('can be present', () => {
        const contact = {email: 'email@example.com'}
        options.senderEmail = 'senderEmail@nowhere.com'
        expect(contactObject(contact, {owner: true}).sender_email).toEqual('senderEmail@nowhere.com')
      })
    });
    describe('reply_to_name', () => {
      ...
      it('can be the defaultSenderName', () => {
        ...
        expect(contactObject(contact, {owner: true}).reply_to_name).toEqual('some sender')
      })
      it('can be the defaultReplyToName', () => {
        const contact = {email: 'email@example.com'}
        options.defaultSenderName = "some sender"
        options.defaultReplyToName = "replyto name"
        expect(contactObject(contact, {owner: true}).reply_to_name).toEqual('replyto name')
      })
      it('can be the ownerName', () => {
        const contact = {first_name: 'owner', last_name: 'lastname', email: 'email@example.com'}
        options.defaultSenderName = "some sender"
        options.defaultReplyToName = "replyto name"
        expect(contactObject(contact, {owner: true}).reply_to_name).toEqual('owner lastname')
      })
    });
    describe('reply_to_email', () => {
      ...
      it('can be the defaultReplyToEmail', () => {
        ...
        expect(contactObject(contact, {owner: true}).reply_to_email).toEqual('default_replyto@example.com')
      })
      it('can be the owner email', () => {
        const contact = {email: 'email.example.com'}
        options.defaultReplyToEmail = "default_replyto@example.com"
        expect(contactObject(contact, {owner: true}).reply_to_email).toEqual('email.example.com')
      })
      it('can be the set replyToEmail', () => {
        const contact = {email: 'email@example.com'}
        options.defaultReplyToEmail = "default_replyto@example.com"
        options.replyToEmail = "replyto@example.com"
        expect(contactObject(contact, {owner: true}).reply_to_email).toEqual('replyto@example.com')
      })
    });
  });
});
